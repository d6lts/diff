...
require_once drupal_get_path('module', 'diff'). '/Text/Diff/Renderer.php';
...
class Text_Diff_Renderer_inline extends Text_Diff_Renderer {
    ...
    {
      // MW: not giving thr result I wanted so out with you. I know not if this corrupts the diff at all  
